...
namespace D1
{
    class Program
    {
        ...
        static long CalculateFuelRequirement(int mass)
        {
            var fuelRequirement = mass / 3 - 2;

            //return fuelRequirement > 0 ? fuelRequirement : 0; // D1P1
            return fuelRequirement > 0 ? fuelRequirement + CalculateFuelRequirement(fuelRequirement) : 0; // D1P2
        }
    }
}
